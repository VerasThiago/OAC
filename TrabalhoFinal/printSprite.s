...
ryuidle: .byte 48, 84, 0, 4
frameSequence: .space 20
hitboxInfo: .space 4
...
block:
	...
	lb $t5, 3($a3)	# current frame
	addi $t5, $t5, 1  # next frame   	
	
	sb $t5, 3($a3)  # next idx in frameSequence 
	move $a0, $v0
	move $a1, $t5	# if next idx is 0, movement is finished
